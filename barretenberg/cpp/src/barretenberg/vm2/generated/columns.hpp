...
#define AVM2_SHIFTED_ENTITIES execution_clk_shift, execution_sel_shift
#define AVM2_TO_BE_SHIFTED(e) e.execution_clk, e.execution_sel
...
#define AVM2_TO_BE_SHIFTED_COLUMNS Column::execution_clk, Column::execution_sel
#define AVM2_SHIFTED_COLUMNS ColumnAndShifts::execution_clk_shift, ColumnAndShifts::execution_sel_shift
// clang-format on
